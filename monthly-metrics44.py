...
df_story_points_bkp = pd.DataFrame({
    "Sprint": ["173", "174", "176", "177", "178", "179", "181", "182", "183", "184", "185", "186"],
    "Committed": [33, 57, 44, 66, 70, 58, 71, 51, 74, 56, 59, 64],
    "Delivered": [25, 16, 7, 24, 42, 40, 70, 34, 61, 24, 18, 53],
    "DaySupport": [ 8, 25, 51, 31, 57, 59, 32, 24, 31, 21, 36, 43],
    "NightSupport" : [ 0, 0, 2, 0, 4, 5, 4, 5, 0, 4, 15, 22],
    "Bug" : [ 0, 0, 2, 0, 3, 5, 3, 1, 1, 1, 0, 1]
        
})
df_story_points = pd.DataFrame({
    "Sprint": ["177", "178", "179", "181", "182", "183", "184", "185", "186"],
    "Committed": [66, 70, 58, 71, 51, 74, 56, 59, 64],
    "Delivered": [24, 42, 40, 70, 34, 61, 24, 18, 53],
    "DaySupport": [31, 57, 59, 32, 24, 31, 21, 36, 43],
    "NightSupport" : [ 0, 4, 5, 4, 5, 0, 4, 15, 22],
    "Bug" : [  0, 3, 5, 3, 1, 1, 1, 0, 1]
